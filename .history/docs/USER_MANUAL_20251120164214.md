...
autoQA 是一个企业级 AI 驱动的自动化测试平台，核心特性包括：
...
**AI测试用例生成器** 是autoQA的核心功能，可以从Axure原型文件一键生成完整的功能测试用例。
...
autoQA 基于 **Playwright** 实现浏览器自动化测试，支持：
...
- 📧 邮箱: support@autoQA.dev
- 🐛 Bug反馈: https://github.com/autoQA/autoQA/issues
- 📚 在线文档: https://docs.autoQA.dev
