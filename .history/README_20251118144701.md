...
[![Version](https://img.shields.io/badge/version-2.5.0-blue.svg)](https://github.com/autoQA/autoQA)
[![License](https://img.shields.io/badge/license-GNU%20GPL-green.svg)](LICENSE)
[![Node](https://img.shields.io/badge/node-%3E%3D18.0.0-brightgreen.svg)](https://nodejs.org)

[快速开始](#-快速开始) · [功能特性](#-核心创新) · [文档](docs/) · [问题反馈](https://github.com/autoQA/autoQA/issues)
...
| 维度 | Selenium/Playwright | 录制回放工具 | **autoQA** |
|------|---------------------|-------------|-------------|
...
- [功能建议](https://github.com/autoQA/autoQA/issues)
...
GNU General Public License v3.0 © autoQA Team
...
**autoQA - 让自动化测试变得简单而强大！** 🚀

Made with ❤️ by autoQA Team
