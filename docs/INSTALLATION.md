...
```bash
# 克隆项目
git clone https://github.com/autoQA/autoQA.git
cd autoQA
...
```bash
DATABASE_URL="mysql://username:password@localhost:3306/autoQA"
```
...
```bash
# ========== AI 模型配置 ==========
# autoQA 支持 4 种 AI 模型,可在前端设置页面一键切换
